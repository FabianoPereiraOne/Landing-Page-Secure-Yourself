...
export const Hero = () => {
  return (
    <main className='w-full overflow-hidden p-[20px] md:p-[36px] before:blur-[200px] relative  before:absolute before:right-0 before:top-0 before:w-[150px] before:h-[150px] lg:before:w-[400px] lg:before:h-[400px] before:bg-red-500 before:rounded-full before:-z-10 lg:before:blur-[400px] '>
      <span className='absolute left-[-16px] top-[100px] w-[550px] h-[36px] bg-yellow-500 rotate-[-15deg] origin-top-left text-black text-xs font-bold uppercase flex items-center md:justify-center'>
        <span className='ml-[36px] md:ml-[-64px]'>
          Atenção: Está Oferta Expira Em Poucas Horas!
        </span>
      </span>
      <div className='w-full max-w-[1400px] mx-auto py-[150px] gap-[100px]  lg:min-h-[70vh] flex flex-col lg:flex-row items-center lg:justify-center'>
        <div className='w-full md:max-w-[500px]'>
          <article className='w-full flex-col'>
            <h1 className='text-left md:text-center lg:text-left text-xl text-red-500 font-extrabold md:text-3xl uppercase'>
              Não seja a próxima vítima:
            </h1>
            <h2 className='text-left md:text-center lg:text-left text-xl text-white font-extrabold md:text-3xl uppercase mt-2'>
            ...
            <div className='w-full flex items-center gap-[16px] mt-6 flex-wrap justify-start md:justify-center lg:justify-start'>
              <Link
                href='/'
                className='bg-red-500 px-6 py-3 text-white text-md font-semibold uppercase rounded-[6px] flex items-center justify-center gap-2 hover:bg-red-600 transition-all ease-in'
              >
                Comprar Agora
                <FiArrowRight />
              </Link>
