export const listCards = [
  {
    title: "Entendendo seus padrões de relacionamento",
    subtitle:
      "Identifique os comportamentos que mantêm você em relações tóxicas."
  },
  {
    title: "O medo e o caos programado",
    subtitle: "Como o medo é usado para controlar e manipular suas decisões."
  },
  {
    title: "Mudando seus padrões",
    subtitle: "Adote novos hábitos para transformar seus relacionamentos."
  },
  {
    title: "Uma estatística do perigo",
    subtitle: "Conheça os números que revelam a gravidade do abuso emocional."
  },
  {
